  ...
  return (
    <ShowcaseSection title="Your Photo" className="!p-7">
      <form>
        ...
        <div className="relative mb-5.5 block w-full rounded-[24px] border border-dashed border-[#DCCFBE] bg-[#FBF7F2] shadow-card transition hover:border-primary dark:border-dark-3 dark:bg-dark-2 dark:hover:border-primary">
          <input
            type="file"
            name="profilePhoto"
            id="profilePhoto"
